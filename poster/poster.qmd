...
custom_palette <- c(
  "Freeze" = "#1f78b4",       # Dark blue
  "Winter Storm" = "#6baed6", # Medium blue
  "Flooding" = "#a6cee3",     # Light blue
  "Drought" = "#e31a1c",      # Dark red
  "Wildfire" = "#fb6a4a",     # Light red
  "Severe Storm" = "#ffa500", # Darker yellow (orange)
  "Tropical Cyclone" = "#ff8c00" # Darker yellow (dark orange)
)

# Create a stacked histogram of the frequency USA from 1980 to 2024
bdd_events_frequency_cost |> ggplot(aes(x = Year, y = Frequency, fill = Disaster)) +
  geom_bar(stat = "identity") +
  labs(
    x = "Year",
    y = "Frequency of billion-dollar disaster",
    title = "Billion-Dollar Disasters in the USA (1980-2024)",
    caption = "Source: NCEI (2024)"
  ) +
  theme_minimal() +
  theme(
  ...
  scale_fill_manual(
    ...
    breaks = c("Drought", "Wildfire", "Freeze", "Winter Storm", "Flooding", "Severe Storm", "Tropical Cyclone"),
    labels = c("Drought", "Wildfire", "Freeze", "Winter Storm", "Flooding", "Severe Storm", "Tropical Cyclone")
  ) +
  guides(
    fill = guide_legend(
