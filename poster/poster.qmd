...
bdd_cost_plot <- ggplot(bdd_cost_combined) +
  ...
  labs(
    ...
    color = "Disaster Type",
    title = "Estimated Cost/Frequncy of Billion-Dollar Disasters in the USA (1980-2024)"
  ) +
  theme_minimal() +
  theme(
    ...
    axis.title.x = element_text(size = 14, hjust = 1.05, margin = margin(t = -13)), # use t = -13 to be in-line with the x-axis, but unable to shift to the right
