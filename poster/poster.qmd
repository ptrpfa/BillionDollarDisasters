...
To highlight the need for enhanced disaster preparedness in the USA, Dottle and Kaufman[^dottle_climate_2023] presented a combined plot visualizing the total estimated costs by disaster type and the frequency of such events from 1980 to 2023. The plot demonstrated the increased frequency of various types of disasters over the years, likely driven by factors such as climate change, along with their escalating financial impact and costs. Coupled with the depletion of the country's Disaster Relief Fund (DRF), this elucidates the dire need for proactive preparations and mitigations to address the growing threat of such disasters effectively.

[^dottle_climate_2023]: Dottle, R., & Kaufman, L. (2023). Climate Disasters Drain US Emergency Fund, Adding to Government Shutdown Risk. Retrieved from https://www.bloomberg.com/graphics/2023-fema-disaster-relief-fund-extreme-weather-climate-aid/
...
custom_palette <- c(
  ...
  "Storm Events" = "#7DC15A", # Darker yellow (light Green)
  "Wet Weather Events" = "#6baed6", # Darker Green (dark Green)
  "Dry Weather Events" = "#fb6a4a" # Dark blue
)
